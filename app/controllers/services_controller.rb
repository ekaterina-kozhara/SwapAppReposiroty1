class ServicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @service.save
        format.html { redirect_to @service, notice: 'Услуга успешно создана' }
  ...
  def update
    respond_to do |format|
      if @service.update(service_params)
        format.html { redirect_to @service, notice: 'Твоё предложение обновлено'}
  ...
  def destroy
    @service.destroy
    respond_to do |format|
      format.html { redirect_to services_url, notice: 'Предложение удалено' }
